# Plot gaussian SVM classifier in the iris dataset
import numpy as np
...
datas = (Xsepal, Xpetal)
models = (svm.SVC(kernel='rbf', gamma=0.7, C=1.0).fit(data, y) for data in datas)
# Set-up 1x2 grid for plotting.
fig, sub = plt.subplots(1, 2)
plt.subplots_adjust(wspace=0.4, hspace=0.4)

# title for the plots
titles = ('SVC with rbf kernel Sepal',
          'SVC with rbf kernel Petal')
